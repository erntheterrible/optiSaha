...
const CustomerListPage = React.lazy(() => import('./features/customers/CustomerListPage'));
const CustomerDetailPage = React.lazy(() => import('./features/customers/CustomerDetailPage'));
const NotesPage = React.lazy(() => import('./features/notes2/NotesPage'));
const DealsPage = React.lazy(() => import('./features/deals/DealsPage'));
    ...
    <I18nextProvider i18n={i18n}>
      <Suspense fallback={<Loader />}>
        ...
        >
          ...
          <Route path="users" element={<UsersPage />} />
          <Route path="user-database" element={<CustomerListPage />} />
